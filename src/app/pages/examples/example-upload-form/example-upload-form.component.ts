...
import { SqlUploadFormComponent } from 'src/app/components/forms/sql-upload-form/sql-upload-form.component';

@Component({
  selector: 'app-example-upload-form',
  standalone: true,
  imports: [CommonModule, SqlFormComponent, SqlDatepickerComponent, SqlInputComponent,
    SqlRadioGroupComponent, SqlSelectComponent, SqlSubmitComponent, SqlTextareaComponent, FormsModule, SqlUploadFormComponent],
  templateUrl: './example-upload-form.component.html',
  styleUrls: ['./example-upload-form.component.css']
})
export class ExampleUploadFormComponent {
  my_date: any;
}
